...
namespace IBuyStuff.Server.Controllers.Business
{
    ...
    public class OrderController : Controller
    {
        ...
        public OrderController(IOrderControllerService service, IMemoryCache cache)
        {
            _service = service;
            _cache = cache;
        }
        ...
        private ShoppingCartViewModel RetrieveCurrentShoppingCart()
        {
            ...
            var cart = _cache.GetOrCreate<ShoppingCartViewModel>(cartName, e => _service.CreateShoppingCartForCustomer(customerId));
            return cart;
        }
